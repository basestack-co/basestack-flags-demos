/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: 0bf445930afe63120758a86ec579d6ee)
...
declare namespace Cloudflare {
	interface Env {
		...
		ASSETS: Fetcher;
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* basestack-flags-demos */;
	}
}
